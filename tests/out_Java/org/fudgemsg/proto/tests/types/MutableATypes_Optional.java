      ...
      try {
        ...
        for (org.fudgemsg.FudgeField fudge3 : fudge1) {
          try {
            ...
            throw new IllegalArgumentException ("Fudge message is not a MutableATypes_Optional - field '_Boolean[]' is not boolean", e);
          }
        }
