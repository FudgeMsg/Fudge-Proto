...
public class MutableAATypes_Required implements java.io.Serializable, AATypesBase {
  ...
  protected MutableAATypes_Required (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    ...
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Required - field '_Boolean' is not present");
    try {
        ...
        try {
          ...
          for (org.fudgemsg.FudgeField fudge6 : fudge4) {
            try {
              ...
              throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Required - field '_Boolean[][]' is not boolean", e);
            }
          }
