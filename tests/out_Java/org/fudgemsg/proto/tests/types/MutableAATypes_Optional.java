...
// Created from types.proto:287(10)
...
public class MutableAATypes_Optional implements java.io.Serializable, AATypesBase {
      ...
      try {
        ...
        for (org.fudgemsg.FudgeField fudge3 : fudge1) {
          try {
            ...
            throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Byte[]' is not byte[]", e);
          }
        }
        set_Byte (fudge2.toArray (new byte[fudge2.size ()][]));
      }
      catch (IllegalArgumentException e) {
        throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Byte' is not byte[][]", e);
      }
      ...
      try {
        ...
        for (org.fudgemsg.FudgeField fudge3 : fudge1) {
          try {
            ...
            throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Double[]' is not double[]", e);
          }
        }
        set_Double (fudge2.toArray (new double[fudge2.size ()][]));
      }
      catch (IllegalArgumentException e) {
        throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Double' is not double[][]", e);
      }
      ...
      try {
        ...
        for (org.fudgemsg.FudgeField fudge3 : fudge1) {
          try {
            ...
            throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Float[]' is not float[]", e);
          }
        }
        set_Float (fudge2.toArray (new float[fudge2.size ()][]));
      }
      catch (IllegalArgumentException e) {
        throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Float' is not float[][]", e);
      }
      ...
      try {
        ...
        for (org.fudgemsg.FudgeField fudge3 : fudge1) {
          try {
            ...
            throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Indicator[]' is not indicator[]", e);
          }
        }
        set_Indicator (fudge2.toArray (new boolean[fudge2.size ()][]));
      }
      catch (IllegalArgumentException e) {
        throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Indicator' is not indicator[][]", e);
      }
      ...
      try {
        ...
        for (org.fudgemsg.FudgeField fudge3 : fudge1) {
          try {
            ...
            throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Int[]' is not integer[]", e);
          }
        }
        set_Int (fudge2.toArray (new int[fudge2.size ()][]));
      }
      catch (IllegalArgumentException e) {
        throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Int' is not integer[][]", e);
      }
      ...
      try {
        ...
        for (org.fudgemsg.FudgeField fudge3 : fudge1) {
          try {
            ...
            throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Long[]' is not long[]", e);
          }
        }
        set_Long (fudge2.toArray (new long[fudge2.size ()][]));
      }
      catch (IllegalArgumentException e) {
        throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Long' is not long[][]", e);
      }
      ...
      try {
        ...
        for (org.fudgemsg.FudgeField fudge3 : fudge1) {
          try {
            ...
            throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Short[]' is not short[]", e);
          }
        }
        set_Short (fudge2.toArray (new short[fudge2.size ()][]));
      }
      catch (IllegalArgumentException e) {
        throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Short' is not short[][]", e);
      }
          ...
          try {
            ...
            for (org.fudgemsg.FudgeField fudge6 : fudge4) {
              try {
                ...
                throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_SubMessage[][]' is not SubMessage message", e);
              }
            }
          ...
          try {
            ...
            for (org.fudgemsg.FudgeField fudge6 : fudge4) {
              try {
                ...
                throw new IllegalArgumentException ("Fudge message is not a MutableAATypes_Optional - field '_Message[][]' is not anonymous/unknown message", e);
              }
            }
  ...
  public MutableAATypes_Optional clone () {
    return new MutableAATypes_Optional (this);
  }
  ...
  public static MutableAATypes_Optional fromFudgeMsg (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("org.fudgemsg.proto.tests.types.MutableAATypes_Optional".equals (className)) break;
      try {
        return (org.fudgemsg.proto.tests.types.MutableAATypes_Optional)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeFieldContainer.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
