...
public class ATypes_Required implements java.io.Serializable, ATypesBase {
  ...
  protected ATypes_Required (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    ...
    try {
      ...
      throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Byte' is not byte[]", e);
    }
    fudgeField = fudgeMsg.getByName (_DOUBLE_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Double' is not present");
    try {
      __Double = fudgeMsg.getFieldValue (double[].class, fudgeField);
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Double' is not double[]", e);
    }
    fudgeField = fudgeMsg.getByName (_FLOAT_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Float' is not present");
    try {
      __Float = fudgeMsg.getFieldValue (float[].class, fudgeField);
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Float' is not float[]", e);
    }
    fudgeField = fudgeMsg.getByName (_INDICATOR_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Indicator' is not present");
    try {
      final org.fudgemsg.FudgeFieldContainer fudge1 = fudgeMsg.getFieldValue (org.fudgemsg.FudgeFieldContainer.class, fudgeField);
      final java.util.List<Boolean> fudge2 = new java.util.ArrayList<Boolean> ();
      for (org.fudgemsg.FudgeField fudge3 : fudge1) {
      ...
      throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Indicator' is not indicator[]", e);
    }
    fudgeField = fudgeMsg.getByName (_INT_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Int' is not present");
    try {
      __Int = fudgeMsg.getFieldValue (int[].class, fudgeField);
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Int' is not integer[]", e);
    }
    fudgeField = fudgeMsg.getByName (_LONG_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Long' is not present");
    try {
      __Long = fudgeMsg.getFieldValue (long[].class, fudgeField);
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Long' is not long[]", e);
    }
    fudgeField = fudgeMsg.getByName (_SHORT_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Short' is not present");
    try {
      __Short = fudgeMsg.getFieldValue (short[].class, fudgeField);
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Short' is not short[]", e);
    }
    fudgeField = fudgeMsg.getByName (_STRING_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_String' is not present");
    try {
      final org.fudgemsg.FudgeFieldContainer fudge1 = fudgeMsg.getFieldValue (org.fudgemsg.FudgeFieldContainer.class, fudgeField);
    ...
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_SubMessage' is not present");
    try {
      final org.fudgemsg.FudgeFieldContainer fudge1 = fudgeMsg.getFieldValue (org.fudgemsg.FudgeFieldContainer.class, fudgeField);
      ...
      for (org.fudgemsg.FudgeField fudge3 : fudge1) {
        try {
          ...
          throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_SubMessage[]' is not SubMessage message", e);
        }
      }
    ...
    try {
      ...
      for (org.fudgemsg.FudgeField fudge3 : fudge1) {
        try {
          ...
          fudge4 = fudgeContext.fieldValueToObject (org.fudgemsg.proto.tests.types.CustomEnum.class, fudge3);
          fudge2.add (fudge4);
        }
        catch (IllegalArgumentException e) {
    ...
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Message' is not present");
    try {
      final org.fudgemsg.FudgeFieldContainer fudge1 = fudgeMsg.getFieldValue (org.fudgemsg.FudgeFieldContainer.class, fudgeField);
      ...
      for (org.fudgemsg.FudgeField fudge3 : fudge1) {
        try {
          ...
          throw new IllegalArgumentException ("Fudge message is not a ATypes_Required - field '_Message[]' is not anonymous/unknown message", e);
        }
      }
  ...
  public static ATypes_Required fromFudgeMsg (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("org.fudgemsg.proto.tests.types.ATypes_Required".equals (className)) break;
      try {
        return (org.fudgemsg.proto.tests.types.ATypes_Required)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeFieldContainer.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
