...
// Created from types.proto:422(10)
package org.fudgemsg.proto.tests.types;
public class MutableFixedArrays_Required implements java.io.Serializable {
  ...
  public MutableFixedArrays_Required (int[] fixedArray1, int[][] fixedArray2, int[][] fixedArray3, int[][] fixedArray4) {
  ...
  protected MutableFixedArrays_Required (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    org.fudgemsg.FudgeField fudgeField;
    fudgeField = fudgeMsg.getByName (FIXEDARRAY1_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray1' is not present");
    try {
      _fixedArray1 = fudgeMsg.getFieldValue (int[].class, fudgeField);
      if (_fixedArray1.length != 42) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray1' is not integer[42]");
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray1' is not integer[42]", e);
    }
    fudgeField = fudgeMsg.getByName (FIXEDARRAY2_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray2' is not present");
    try {
      ...
      for (org.fudgemsg.FudgeField fudge3 : fudge1) {
        try {
          if (fudge1.getFieldValue (int[].class, fudge3).length != 42) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray2[]' is not integer[42]");
          fudge2.add (fudge1.getFieldValue (int[].class, fudge3));
        }
        catch (IllegalArgumentException e) {
          throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray2[]' is not integer[42]", e);
        }
      }
    ...
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray3' is not present");
    try {
      final org.fudgemsg.FudgeFieldContainer fudge1 = fudgeMsg.getFieldValue (org.fudgemsg.FudgeFieldContainer.class, fudgeField);
      final java.util.List<int[]> fudge2 = new java.util.ArrayList<int[]> ();
      for (org.fudgemsg.FudgeField fudge3 : fudge1) {
        try {
          ...
          throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray3[]' is not integer[]", e);
        }
      }
      _fixedArray3 = fudge2.toArray (new int[fudge2.size ()][]);
      if (_fixedArray3.length != 42) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray3' is not integer[][42]");
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray3' is not integer[][42]", e);
    }
    fudgeField = fudgeMsg.getByName (FIXEDARRAY4_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray4' is not present");
    try {
      final org.fudgemsg.FudgeFieldContainer fudge1 = fudgeMsg.getFieldValue (org.fudgemsg.FudgeFieldContainer.class, fudgeField);
      final java.util.List<int[]> fudge2 = new java.util.ArrayList<int[]> ();
      for (org.fudgemsg.FudgeField fudge3 : fudge1) {
        try {
          if (fudge1.getFieldValue (int[].class, fudge3).length != 42) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray4[]' is not integer[42]");
          fudge2.add (fudge1.getFieldValue (int[].class, fudge3));
        }
        catch (IllegalArgumentException e) {
          throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray4[]' is not integer[42]", e);
        }
      }
      _fixedArray4 = fudge2.toArray (new int[fudge2.size ()][]);
      if (_fixedArray4.length != 42) throw new IllegalArgumentException ("Fudge message is not a MutableFixedArrays_Required - field 'fixedArray4' is not integer[42][42]");
    }
    catch (IllegalArgumentException e) {
