...
public class InheritanceTest {
  ...
  public void testBaseClassA () {
    ...
    FudgeMsg m = bcA.toFudgeMsg (new FudgeContext ());
  ...
  public void testBaseClassB () {
    ...
    FudgeMsg m = bcB.toFudgeMsg (new FudgeContext ());
    System.out.println (m);
  ...
  public void testSubClassA () {
    ...
    FudgeMsg m = scA.toFudgeMsg (new FudgeContext ());
    System.out.println (m);
  ...
  public void testSubClassA2 () {
    ...
    FudgeMsg m = scA2.toFudgeMsg (new FudgeContext ());
    System.out.println (m);
